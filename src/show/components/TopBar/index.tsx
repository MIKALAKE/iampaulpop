...
const TopBar = () => (
  <section className='fixed top-0 z-50 my-2 w-full px-2'>
    <div className='bg-background/20 mx-auto w-full rounded-full py-1 pr-5 pl-1 shadow-md backdrop-blur-md transition-all duration-150 lg:max-w-5xl dark:bg-white/10'>
      <nav className='flex h-12 w-full items-center justify-between rounded-full px-5 py-1 text-sm text-black select-none'>
        <a
          href='/'
          aria-label='Paul Pop'
